...
# Points: Dictionary with the PointID as key and a ad-hoc object with PosX, PosY and a list of PIL.Image.Image as value.
# Settings.TimeDelta: Time between two images, iin milliseconds.
# Settings.Scale: Image scaling, in pixels per millimeters.
